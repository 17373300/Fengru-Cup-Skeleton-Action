...
path = r'/Volumes/Samsung_T5/冯如杯/nturgb+d_skeletons'
assert os.path.exists(path), 'files path does not exist!'
...
def gendata(data_path,
    ...
    for filename in os.listdir(data_path):
        if filename[0] != 'S':  # I add: ignore the ._ files
            continue
